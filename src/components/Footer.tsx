...
export const Footer = () => {
  ...
  return (
    <>
      ...
      <a 
        href="#" 
        className="fixed bottom-6 left-6 z-50 bg-[#25D366] text-white p-3.5 rounded-full shadow-[0_4px_14px_0_rgba(37,211,102,0.39)] hover:scale-110 hover:-translate-y-1 transition-all duration-300"
      ...
      {showScrollTop && (
        <button 
          onClick={scrollToTop}
          className="fixed bottom-6 right-6 z-50 bg-[#14b8a6] text-white p-3.5 rounded-sm shadow-md hover:bg-teal-600 hover:-translate-y-1 transition-all duration-300"
          title="Scroll to top"
        >
